        ...
        <div className='flex flex-col'>
            ...
            <div className='z-40 flex mt-12 sm:mt-14 xl:mt-16'>
                ...
                <div id='drawer' className='text-xs md:text-xl xl:text-2xl flex flex-col fixed z-40 h-screen p-4 overflow-y-auto bg-[#d3d1ff] w-[50%] sm:w-[40%] lg:w-[30%] xl:w-[20%] right-0 transition-transform translate-x-full shadow-md'>
                    <Link className='p-1 sm:p-2 m-2 bg-[#6c63ff] shadow-md shadow-gray-700 text-[#070351] hover:text-[#070351] focus:shadow-sm focus:translate-y-1'>Profile</Link>
                    <Link className='p-1 sm:p-2 m-2 bg-[#6c63ff] shadow-md shadow-gray-700 text-[#070351] hover:text-[#070351] focus:shadow-sm focus:translate-y-1' to='/newresume'>Create New Resume</Link>
                    <Link className='p-1 sm:p-2 m-2 bg-[#6c63ff] shadow-md shadow-gray-700 text-[#070351] hover:text-[#070351] focus:shadow-sm focus:translate-y-1'>My Resumes</Link>
