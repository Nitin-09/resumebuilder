...
function InputControl({ label, ...props }) {
  return (
    <div className='flex flex-col gap-1 w-full px-10 group'>
      ...
      {props.input!=="no" && <input id={label} autoComplete="do-not-autofill" className='border-black border-b h-11 outline-none p-3 rounded-sm focus:border-blue-500' {...props} />}
