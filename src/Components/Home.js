                    ...
                    <div className="flex items-center justify-center w-full h-full sm:py-8 px-4">
                        <div className="w-full relative flex items-center justify-center">
                            ...
                            <div className="w-full h-full overflow-x-hidden overflow-y-hidden">
                                <div id="slider" className="h-full flex gap-6 items-center justify-start transition ease-out duration-700">
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template0.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template1.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template2.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template3.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template4.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template5.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template6.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template7.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template8.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                        <img src="./resume/template0.png" alt="" className="h-[50vh] lg:h-[75vh] w-full border-2 border-black" />
                                    </div>
                ...
                <div className='relative py-10'>
                    ...
                    <div className="relative lg:h-[55vh]">
                        <div id='1' className="relative w-full overflow-hidden ">
                            <div className={`relative float-left -mr-[100%] w-full flex flex-col lg:flex-row transition-transform duration-300 ${activeSlide === 1 ? 'translate-x-0' : 'translate-x-full'}`} >
                            ...
                            <div id='2' className={`relative float-left -mr-[100%] w-full flex flex-col lg:flex-row transition-transform duration-300 ${activeSlide === 2 ? 'translate-x-0' : 'translate-x-full'}`}>
                            ...
                            <div id='3' className={`relative float-left -mr-[100%] w-full flex flex-col lg:flex-row transition-transform duration-300 ${activeSlide === 3 ? 'translate-x-0' : 'translate-x-full'}`}>
